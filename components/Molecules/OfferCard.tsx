export default function OfferCard() {
  ...
  return (
    <div className="offerCard max-w-md h-full">
        <div className="offerCard__image relative border border-slate-100 bg-teal-50 p-4 h-full flex flex-col justify-between">
